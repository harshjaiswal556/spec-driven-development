---
spec_id: MIRROR-03-SERVICES-SERVICE-C-FEATURE-01-README-MD
title: Service C Feature 01: Daily Totals
source_path: product-specs/03-services/service-c/feature-01/README.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-03-SERVICES-SERVICE-C-FEATURE-01-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-C-FEATURE-01-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-C-FEATURE-01-README-MD-003: The visible active path matches the source path.
