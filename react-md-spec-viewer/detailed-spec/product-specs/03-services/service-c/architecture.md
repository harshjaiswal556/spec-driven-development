---
spec_id: MIRROR-03-SERVICES-SERVICE-C-ARCHITECTURE-MD
title: Service C Architecture
source_path: product-specs/03-services/service-c/architecture.md
version: 1.0
status: DRAFT
owner_team: frontend-product
---

# Service C Architecture
...
- AC-MIRROR-03-SERVICES-SERVICE-C-ARCHITECTURE-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-C-ARCHITECTURE-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-C-ARCHITECTURE-MD-003: The visible active path matches the source path.
