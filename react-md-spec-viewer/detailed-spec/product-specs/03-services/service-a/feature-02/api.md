---
spec_id: MIRROR-03-SERVICES-SERVICE-A-FEATURE-02-API-MD
title: API: Customer Search
source_path: product-specs/03-services/service-a/feature-02/api.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-02-API-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-02-API-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-02-API-MD-003: The visible active path matches the source path.
