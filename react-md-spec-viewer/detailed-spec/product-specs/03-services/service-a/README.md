---
spec_id: MIRROR-03-SERVICES-SERVICE-A-README-MD
title: Service A
source_path: product-specs/03-services/service-a/README.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-03-SERVICES-SERVICE-A-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-A-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-A-README-MD-003: The visible active path matches the source path.
