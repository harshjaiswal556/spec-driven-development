---
spec_id: MIRROR-03-SERVICES-SERVICE-A-FEATURE-04-README-MD
title: Service A Feature 04: Customer Deletion
source_path: product-specs/03-services/service-a/feature-04/README.md
version: 1.0
status: DRAFT
owner_team: frontend-product
---

# Service A Feature 04: Customer Deletion
...
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-04-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-04-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-04-README-MD-003: The visible active path matches the source path.
