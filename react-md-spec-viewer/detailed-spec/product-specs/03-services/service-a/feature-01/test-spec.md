---
spec_id: MIRROR-03-SERVICES-SERVICE-A-FEATURE-01-TEST-SPEC-MD
title: Test Specification: Customer Registration
source_path: product-specs/03-services/service-a/feature-01/test-spec.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-01-TEST-SPEC-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-01-TEST-SPEC-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-01-TEST-SPEC-MD-003: The visible active path matches the source path.
