---
spec_id: MIRROR-03-SERVICES-SERVICE-A-FEATURE-03-README-MD
title: Service A Feature 03: Customer Update
source_path: product-specs/03-services/service-a/feature-03/README.md
version: 1.0
status: DRAFT
owner_team: frontend-product
---

# Service A Feature 03: Customer Update
...
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-03-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-03-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-A-FEATURE-03-README-MD-003: The visible active path matches the source path.
