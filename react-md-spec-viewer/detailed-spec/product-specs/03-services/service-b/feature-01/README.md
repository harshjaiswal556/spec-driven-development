---
spec_id: MIRROR-03-SERVICES-SERVICE-B-FEATURE-01-README-MD
title: Service B Feature 01: Welcome Message
source_path: product-specs/03-services/service-b/feature-01/README.md
version: 1.0
status: DRAFT
owner_team: frontend-product
---

# Service B Feature 01: Welcome Message
...
- AC-MIRROR-03-SERVICES-SERVICE-B-FEATURE-01-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-B-FEATURE-01-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-B-FEATURE-01-README-MD-003: The visible active path matches the source path.
