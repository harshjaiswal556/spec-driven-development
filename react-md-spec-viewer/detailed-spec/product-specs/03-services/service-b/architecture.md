---
spec_id: MIRROR-03-SERVICES-SERVICE-B-ARCHITECTURE-MD
title: Service B Architecture
source_path: product-specs/03-services/service-b/architecture.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-03-SERVICES-SERVICE-B-ARCHITECTURE-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-B-ARCHITECTURE-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-B-ARCHITECTURE-MD-003: The visible active path matches the source path.
