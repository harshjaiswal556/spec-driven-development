---
spec_id: MIRROR-03-SERVICES-SERVICE-B-FEATURE-07-README-MD
title: Service B Feature 07: Audit
source_path: product-specs/03-services/service-b/feature-07/README.md
version: 1.0
status: DRAFT
owner_team: frontend-product
---

# Service B Feature 07: Audit
...
- AC-MIRROR-03-SERVICES-SERVICE-B-FEATURE-07-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-03-SERVICES-SERVICE-B-FEATURE-07-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-03-SERVICES-SERVICE-B-FEATURE-07-README-MD-003: The visible active path matches the source path.
