---
spec_id: MIRROR-02-ARCHITECTURE-SYSTEM-ARCHITECTURE-MD
title: System Architecture
source_path: product-specs/02-architecture/system-architecture.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-02-ARCHITECTURE-SYSTEM-ARCHITECTURE-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-02-ARCHITECTURE-SYSTEM-ARCHITECTURE-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-02-ARCHITECTURE-SYSTEM-ARCHITECTURE-MD-003: The visible active path matches the source path.
