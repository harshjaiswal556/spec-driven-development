---
spec_id: MIRROR-05-ADR-README-MD
title: Architecture Decision Records
source_path: product-specs/05-adr/README.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-05-ADR-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-05-ADR-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-05-ADR-README-MD-003: The visible active path matches the source path.
