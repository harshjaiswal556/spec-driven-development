---
spec_id: MIRROR-05-ADR-ADR-002-MD
title: ADR-002: Use Stable Customer IDs
source_path: product-specs/05-adr/ADR-002.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-05-ADR-ADR-002-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-05-ADR-ADR-002-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-05-ADR-ADR-002-MD-003: The visible active path matches the source path.
