---
spec_id: MIRROR-04-CROSS-SERVICE-WORKFLOWS-REGISTRATION-ONBOARDING-MD
title: Registration Onboarding Workflow
source_path: product-specs/04-cross-service/workflows/registration-onboarding.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-04-CROSS-SERVICE-WORKFLOWS-REGISTRATION-ONBOARDING-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-04-CROSS-SERVICE-WORKFLOWS-REGISTRATION-ONBOARDING-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-04-CROSS-SERVICE-WORKFLOWS-REGISTRATION-ONBOARDING-MD-003: The visible active path matches the source path.
