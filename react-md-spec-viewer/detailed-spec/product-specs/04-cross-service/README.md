---
spec_id: MIRROR-04-CROSS-SERVICE-README-MD
title: Cross-Service Specifications
source_path: product-specs/04-cross-service/README.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-04-CROSS-SERVICE-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-04-CROSS-SERVICE-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-04-CROSS-SERVICE-README-MD-003: The visible active path matches the source path.
