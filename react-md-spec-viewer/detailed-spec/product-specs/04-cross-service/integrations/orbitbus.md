---
spec_id: MIRROR-04-CROSS-SERVICE-INTEGRATIONS-ORBITBUS-MD
title: OrbitBus Integration
source_path: product-specs/04-cross-service/integrations/orbitbus.md
version: 1.0
status: DRAFT
owner_team: frontend-product
---

# OrbitBus Integration
...
- AC-MIRROR-04-CROSS-SERVICE-INTEGRATIONS-ORBITBUS-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-04-CROSS-SERVICE-INTEGRATIONS-ORBITBUS-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-04-CROSS-SERVICE-INTEGRATIONS-ORBITBUS-MD-003: The visible active path matches the source path.
