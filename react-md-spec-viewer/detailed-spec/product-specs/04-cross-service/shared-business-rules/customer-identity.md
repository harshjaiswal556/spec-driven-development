---
spec_id: MIRROR-04-CROSS-SERVICE-SHARED-BUSINESS-RULES-CUSTOMER-IDENTITY-MD
title: Shared Customer Identity Rules
source_path: product-specs/04-cross-service/shared-business-rules/customer-identity.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-04-CROSS-SERVICE-SHARED-BUSINESS-RULES-CUSTOMER-IDENTITY-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-04-CROSS-SERVICE-SHARED-BUSINESS-RULES-CUSTOMER-IDENTITY-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-04-CROSS-SERVICE-SHARED-BUSINESS-RULES-CUSTOMER-IDENTITY-MD-003: The visible active path matches the source path.
