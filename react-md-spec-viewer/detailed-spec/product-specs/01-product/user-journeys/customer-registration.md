---
spec_id: MIRROR-01-PRODUCT-USER-JOURNEYS-CUSTOMER-REGISTRATION-MD
title: Customer Registration Journey
source_path: product-specs/01-product/user-journeys/customer-registration.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-01-PRODUCT-USER-JOURNEYS-CUSTOMER-REGISTRATION-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-01-PRODUCT-USER-JOURNEYS-CUSTOMER-REGISTRATION-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-01-PRODUCT-USER-JOURNEYS-CUSTOMER-REGISTRATION-MD-003: The visible active path matches the source path.
