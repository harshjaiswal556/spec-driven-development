---
spec_id: MIRROR-TEMPLATES-SPEC-TEMPLATE-MD
title: Dummy Feature
source_path: product-specs/templates/spec-template.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-TEMPLATES-SPEC-TEMPLATE-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-TEMPLATES-SPEC-TEMPLATE-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-TEMPLATES-SPEC-TEMPLATE-MD-003: The visible active path matches the source path.
