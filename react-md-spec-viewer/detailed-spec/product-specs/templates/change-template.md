---
spec_id: MIRROR-TEMPLATES-CHANGE-TEMPLATE-MD
title: Change Proposal: DEMO-000
source_path: product-specs/templates/change-template.md
version: 1.0
status: DRAFT
owner_team: frontend-product
---

# Change Proposal: DEMO-000
...
- AC-MIRROR-TEMPLATES-CHANGE-TEMPLATE-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-TEMPLATES-CHANGE-TEMPLATE-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-TEMPLATES-CHANGE-TEMPLATE-MD-003: The visible active path matches the source path.
