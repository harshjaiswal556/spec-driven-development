---
spec_id: MIRROR-README-MD
title: Product Specifications
source_path: product-specs/README.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-README-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-README-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-README-MD-003: The visible active path matches the source path.
