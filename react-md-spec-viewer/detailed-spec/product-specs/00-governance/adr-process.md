---
spec_id: MIRROR-00-GOVERNANCE-ADR-PROCESS-MD
title: ADR Process
source_path: product-specs/00-governance/adr-process.md
version: 1.0
status: DRAFT
...
- AC-MIRROR-00-GOVERNANCE-ADR-PROCESS-MD-001: The file appears at $displayPath in the interactive tree.
- AC-MIRROR-00-GOVERNANCE-ADR-PROCESS-MD-002: Opening the file renders the original Markdown content.
- AC-MIRROR-00-GOVERNANCE-ADR-PROCESS-MD-003: The visible active path matches the source path.
